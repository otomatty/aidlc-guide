# Health Check Report — Docs i18n Bolt 2
...
| Signal | Status |
|--------|--------|
| Library resolve path | Healthy (unit smoke) |
| API official-docs routes | Healthy (integration smoke) |
| Docs Shell Webview behaviors | Healthy (UI smoke) |
| Extension host live session | Not checked this run (manual) |
