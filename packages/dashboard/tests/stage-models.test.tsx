...
import { StageModelLabel } from "../src/components/StageModelLabel.tsx";
import { StageModelsRail } from "../src/components/StageModelsRail.tsx";
import { StageRail } from "../src/components/StageRail.tsx";
import { fetchStageModels } from "../src/services/api.ts";
import { stageView, workflow } from "./fixtures.ts";

vi.mock("../src/services/api.ts", () => ({ fetchStageModels: vi.fn() }));
