 ...
 * aidlc-workflows docs under `docs/<section>/<locale>/`.
 *
 * Public DocPath convention: `guide/getting-started.md`,
 * `reference/scopes.md`, `harness-engineering/00-overview.md`
 * (relative to `docs/`, never includes locale).
 *
