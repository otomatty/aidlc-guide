...
`bun .cursor/tools/aidlc.ts engine worktree <args...>`, passing each saved arg exactly as a
...
`bun .cursor/tools/aidlc.ts engine worktree restore --slug <bolt-slug> [--parked <stamp>]
...
`bun .cursor/tools/aidlc.ts engine worktree purge --slug <bolt-slug> [--parked <stamp> |
